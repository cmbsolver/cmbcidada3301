...
namespace LiberPrimusAnalysisTool.Application.Commands.Image.PixelProcessing
{
    ...
    public class ProcessSingleToBytes
    {
        ...
        public class Handler : INotificationHandler<Command>
        {
            ...
            {
                AnsiConsole.WriteLine($"ProcessSingleToBytes-{request.Method}: Getting bits from {request.PixelData.Item1.PageName}");
                ...
                AnsiConsole.WriteLine($"ProcessSingleToBytes-{request.Method}: Building bytes for bits for {request.PixelData.Item1.PageName}");
                ...
                AnsiConsole.WriteLine($"ProcessSingleToBytes-{request.Method}: Outputting bin file for {request.PixelData.Item1.PageName}");
