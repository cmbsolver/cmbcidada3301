...
namespace FileTypeInterrogator
{
    ...
    public abstract class BaseFileTypeInterrogator : IFileTypeInterrogator
    {
        ...
        /// <returns>
        ///   <c>true</c> if the specified input is text; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <param name="input">The input.</param>
        /// <returns>
        ///   <c>true</c> if the specified input is ASCII; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <param name="hasBOM">if set to <c>true</c> [has bom].</param>
        /// <returns>
        ///   <c>true</c> if [is ut f8] [the specified input]; otherwise, <c>false</c>.
        /// </returns>
